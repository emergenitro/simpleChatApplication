...
client = MongoClient(f"mongodb://{os.getenv('envUsername')}:{os.getenv('envPassword')}@ac-siyibou-shard-00-00.nducqa6.mongodb.net:27017,ac-siyibou-shard-00-01.nducqa6.mongodb.net:27017,ac-siyibou-shard-00-02.nducqa6.mongodb.net:27017/?ssl=true&replicaSet=atlas-mkrclc-shard-0&authSource=admin&retryWrites=true&w=majority")
